...
class SolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post solutions_url, params: { solution: { author: @solution.author, body: @solution.body, section: @solution.section, tags: @solution.tags, title: @solution.title } }
    end
  ...
  test "should update solution" do
    patch solution_url(@solution), params: { solution: { author: @solution.author, body: @solution.body, section: @solution.section, tags: @solution.tags, title: @solution.title } }
